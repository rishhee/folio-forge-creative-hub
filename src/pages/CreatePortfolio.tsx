...
const CreatePortfolio = () => {
  ...
  const categories = ['UI/UX', 'Branding', 'Illustration', 'Photography', 'Web Design', 'Print', '3D'];
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-xl shadow-lg p-12">
            ...
            <p className="text-gray-600 mb-6">You need to be signed in to create a portfolio.</p>
            <button
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {formData.tags.map(tag => (
                <span key={tag} className="flex items-center px-3 py-1 bg-purple-100 text-purple-600 rounded-full text-sm">
                  #{tag}
                  <button
                    type="button"
          ...
          <div className="mb-8">
            ...
            >
              ...
              <label className="inline-flex items-center px-6 py-3 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors cursor-pointer">
                Browse Files
                <input
                  type="file"
                  multiple
