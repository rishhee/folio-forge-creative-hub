      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-8">Viewing project with ID: {id}</p>
            ...
            <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-8 text-center">
              ...
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">Project Details Coming Soon</h2>
              <p className="text-gray-600 mb-6">
                This page will display detailed information about the selected project including images, 
                description, creator info, and interactions.
              </p>
              <Link 
                to="/" 
